...
# define function
df = pd.read_csv(input_file_path, delimiter=' ', skipinitialspace=True, encoding='utf-8')
...
file_path = 'filetempout.txt'  # Replace 'your_file.txt' with the actual path to your file
...
output_file_path = 'finaloutput_dmtool.txt'  # Replace 'output.txt' with the desired output file path
